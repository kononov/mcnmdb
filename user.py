...
class Group(db.Model, BaseMixin):
    ...
    roles       = db.relationship('Group',
        secondary=roles_groups,
        backref = db.backref('groups_with_this_role', lazy='dynamic'))
...
class User(db.Model, UserMixin, BaseMixin):
    ...
    roles = db.relationship('Role',
        ...
        backref = db.backref('users_with_this_role', lazy='dynamic'))

	# список всех групп куда входит этот пользователь ролей
    groups = db.relationship('Group',
        secondary = groups_users,
        backref = db.backref('users_in_this_group', lazy='dynamic'))
    ...
    offers = db.relationship('Offer',
        backref = db.backref('who_add', lazy='dynamic'))
    ...
    corporations = db.relationship('Corporation',
        backref = db.backref('who_add', lazy='dynamic'))
